            ...
            <div className="p-4 origin-bottom-right lg:mx-36 md:mx-8">
                <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                    ...
                    <div className="pr-4 md:flex md:flex-col md:justify-center align-middle pt-24">
                        ...
                        <h2 className="self-center mb-4 text-5xl font-bold tracking-wider text-tertiary font-carattere md:text-4xl lg:text-7xl">EduTech</h2>

                        <p className="self-center text-xl tracking-wide text-justify text-white">EduTech is an AR-based web platform where students come across and learn about various complex biology topics. Learn with the help of interactive 3D Models and Augnmented Reality.</p>
